...
{
    public class CVMEditTasker
    {
        public int id { get; set; } // 對應到TaskerIndex.cshtml Edit按鈕的id
        public List<Tasker> taskers { get; set; }
        public List<TaskerService> taskersService { get; set; }


        public List<SelectListItem> serviceAreaList { get; set; }

        public List<SelectListItem> cityList = new List<SelectListItem>()// 服務地區清單
        {
        ...
        public CVMEditTasker()
        {
            serviceAreaList = cityList;
        }

        // public bool isChecked { get; set; } // 有空再試CheckBoxFor
    }
}